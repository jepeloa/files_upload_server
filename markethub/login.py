...
def main():
    ...
    save_path = './files/markethub'  # Cambia esto por la ruta donde quieres guardar los archivos
    st.image('./logo_markethub.png', width=50)  # Ajusta la ruta y el tamaño según tus necesidades
